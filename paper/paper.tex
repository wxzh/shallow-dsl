...
to optimize the use of procedural abstraction, they ought to have some 
...
argument by taking a recent paper by Gibbons, where procedural
...
an annotation that uses transparent code generation techniques to
automatically eliminate large portions of boilerplate code in Java.
To further illustrate the applicability of our techniques, we conduct 
