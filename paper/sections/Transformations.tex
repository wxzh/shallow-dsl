...
These methods are interfaces exposed to DSL clients, e.g.
\lstinputlisting[linerange=5-6]{../src/test/Test.scala}%APPLY:CLIENT
By importing a different package, clients can change the semantics with the majority of the code untouched.
