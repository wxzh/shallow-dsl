...
\bruno{I would try to avoid Scala-specific things like extractors as
  much as possible here. You can just define, for example:

def Fan (x : Int) = new Fan\{val n=x\}

This is shorter, and less language-specific.
}
...
\bruno{Please try to put more code in single lines:
