...
In this paper, however, we prefer to interpret shallow and deep embeddings
...
first review some of the limitations of shallow embeddings commonly
...
Haskell.
 \bruno{double-check if the paper really shows this!}
