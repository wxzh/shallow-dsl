...
\lstinputlisting[linerange=11-17]{./code/shallowCircuit.hs}%APPLY:CIRCUIT1
...
\lstinputlisting[linerange=21-28]{./code/shallowCircuit.hs}%APPLY:CIRCUIT2
...
\lstinputlisting[linerange=33-38]{./code/shallowCircuit.hs}%APPLY:CIRCUIT3
