...
\lstinputlisting[language=haskell,linerange=29-61]{../src/paper/sec2/Circuit.java}%APPLY:DESUGAR_OO
...
\lstinputlisting[language=haskell,linerange=40-55]{./code/shallowCircuit.hs}%APPLY:DESUGAR
