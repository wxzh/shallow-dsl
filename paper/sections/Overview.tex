...
\lstinputlisting[language=haskell,linerange=2-9]{./code/NewSemantics.hs}%APPLY:SEMANTICS_HS
...
\lstinputlisting[language=haskell,linerange=39-40]{./code/shallowCircuit.hs}%APPLY:SYNTAX_TYPES
...
\lstinputlisting[language=haskell,linerange=44-45]{./code/shallowCircuit.hs}%APPLY:SYNTAX_HS
