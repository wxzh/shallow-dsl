...
\lstinputlisting[language=haskell,linerange=42-43]{./code/shallowCircuit.hs}%APPLY:SYNTAX_TYPES
...
\lstinputlisting[language=haskell,linerange=47-48]{./code/shallowCircuit.hs}%APPLY:SYNTAX_HS
