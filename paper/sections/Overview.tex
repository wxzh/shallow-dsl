...
To add these two new constructs to \dsl, we can declare two class-like interfaces \texttt{Above} and
\texttt{Stretch} that extends \texttt{Circuit} with \texttt{width} and
\texttt{wellSized} implemented

\lstinputlisting[linerange=56-76]{../src/paper/sec3/Circuit.java}%APPLY:DEPENDENT
...
\lstinputlisting[linerange=98-130]{../src/paper/sec3/Circuit.java}%APPLY:CONTEXT_SENSITIVE
...
\lstinputlisting[linerange=161-163]{../src/paper/sec3/Circuit.java}%APPLY:MERGE
...
\lstinputlisting[linerange=168-180]{../src/paper/sec3/Circuit.java}%APPLY:INSTRUMENT
