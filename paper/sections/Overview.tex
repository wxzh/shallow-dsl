...
\lstinputlisting[language=haskell,linerange=29-30]{./code/shallowCircuit.hs}%APPLY:SYNTAX_TYPES
...
\lstinputlisting[language=haskell,linerange=34-35]{./code/shallowCircuit.hs}%APPLY:SYNTAX_HS
