...
shallow embeddings can only support a single DSL interpretation.


{\bf Approach.}
In this paper we argue that 
shallow embedded domain-specific languages (EDSLs) and Object-Oriented
...
{\bf Knowledge.}
This pearl argues that common OOP mechanisms
...
{\bf Grounding}
We make our
arguments by taking a recent paper by Gibbons and Wu, where procedural
abstraction is used in Haskell to model a simple shallow EDSL, and we recode
that EDSL both in Scala and with an improved OO-inspired Haskell encoding. 
...
{\bf Importance.} This work is important for two different
reasons. Firstly, from an intelectual point of view, this work
establishes the connection between shallow embeddings and 
Object-Oriented Programming, which enables a better understanding
of both concepts. Secondly, this work
offers new programming techniques that can be used to improve 
