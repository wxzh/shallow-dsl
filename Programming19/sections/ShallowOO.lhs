...
|stretch ns c| inserts wires into the circuit |c| so that the $i^{th}$ wire of |c| is stretched to a position of $ns_1 + ... + ns_i$, resulting in a new circuit of width by summing up |ns|.
