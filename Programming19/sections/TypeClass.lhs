...
Bahr~\cite{Bahr}, to express a subtyping relation on tuples:
...
of \emph{intersection types} proposed by Dunfield~\cite{}\bruno{reference}, where
...
parameter as |Width :<: c|.  Such constraint allows us to simulate the
