...
embeddings when implementing a DSL: there are some tradeoffs between
the two styles. A nice aspect of shallow embeddings is their
simplicity. Deep embeddings trade some simplicity and the ability to
